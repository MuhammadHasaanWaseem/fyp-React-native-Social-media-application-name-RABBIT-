    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#0A0A0A" }}>
      ...
      <HStack className="items-center justify-between p-6">
        <VStack>
          ...
          <HStack className="items-center" style={{ marginTop: 5 }}>
            <Text style={{ color: "white", fontSize: 12, fontWeight: "900" }}>username : </Text>
            <Text style={{ color: "white", fontSize: 12 }}>@{user?.username || "Not set"}</Text>
          </HStack>
        </VStack>
        {/* Clickable avatar */}
        <Pressable onPress={() => {}}>
...
// import { User } from "@/lib/type";
// import { Text, Pressable, Alert, FlatList, SafeAreaView } from "react-native";
// import { HStack } from "../ui/hstack";
// import { Avatar, AvatarImage, AvatarFallbackText, AvatarGroup } from "../ui/avatar";
// import { Button, ButtonText } from "../ui/button";
// import { Divider } from "../ui/divider";
...
//           <HStack className="items-center" style={{ marginTop: 5 }}>
//             <Text style={{ color: "white", fontSize: 12, fontWeight: "900" }}>Bio : </Text>
//             <Text style={{ color: "white", fontSize: 9 }}> {user?.bio || "Not set"}
//             </Text></HStack>
//             <HStack className="items-center" style={{ marginTop: 5 }}>
//             <Text style={{ color: "white", fontSize: 12, fontWeight: "900" }}>Nickname : </Text>
//             <Text style={{ color: "white", fontSize: 9 }}>{user?.nickname || "Not set"}</Text>
//           </HStack>
//         </VStack>
//         {/* Clickable avatar */}
//         <Pressable onPress={()=>{}}>
